import 'package:caisse_tectille/screens/stock/sortie.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../menu/items_menu.dart';
import 'apercu.dart';
import 'entrer/entrer.dart';
class StockScreen extends StatefulWidget implements PreferredSizeWidget{
  final String username; // Propriété pour stocker le nom d'utilisateur
  @override
  Size get preferredSize => Size.fromHeight(kToolbarHeight);

  StockScreen({required this.username});
  @override
  StockScreenSatet createState() => StockScreenSatet();
}
class StockScreenSatet extends State<StockScreen> {
  List<String> _menuIcons = [
    'assets/assets/apercu.png',
    'assets/assets/entrer.png',
    'assets/assets/sortiee.png',
    //'assets/reactif.png',
  ...
  Widget build(BuildContext context) {
    return AppBar(
      title: Row(
        ...
        Spacer(),
          Text('STOCK', style: TextStyle(color: Colors.white, fontSize: 16)),
          Spacer(),
        ],
